...
const Main = () => {
  return (
    <div className="flex-col md:inline-flex absolute z-10 w-full">
      <div className="select-none mt-20 mx-auto md:mt-30 md:ml-40 text-center md:text-left text-white roddenberry bg-black bg-opacity-40">
        <h1 className="text-7xl md:text-9xl">Hi, I'm Deann.</h1>
        <h1 className="text-4xl mt-10 md:text-6xl">
          A fullStack JavaScript developer.
        </h1>
      </div>
      <div className="mt-10 flex justify-center md:absolute md:mt-30 md:right-0 md:mr-40">
