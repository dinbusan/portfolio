...
const Main = () => {
  ...
  transition={ { duration: 0.3 }}
    >
      <div className="select-none mt-20 lg:mt-40 mx-auto xl:mt-30 xl:ml-40 text-center xl:text-left text-white roddenberry bg-black bg-opacity-20 md:bg-opacity-40">
