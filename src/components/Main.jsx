...
const Main = () => {
  return (
    <div className="flex-col xl:inline-flex absolute w-full">
      <div className="select-none mt-20 lg:mt-40 mx-auto xl:mt-30 xl:ml-40 text-center xl:text-left text-white roddenberry bg-black bg-opacity-40">
